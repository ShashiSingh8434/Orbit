...
import '../../../core/ai/prompts/decision_agent_prompt.dart';
          ...
          children: [
            ...
            if (!_isEditing)
              AiForm(
                ...
                onSubmit: _submitAi,
                infoText:
                    'Describe your decision and reasoning in plain language — Orbit AI will extract and structure it for you.',
              ),
          ],
        ),
      ),
