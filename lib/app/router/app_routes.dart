abstract final class AppRoutes {
  ...
  // ── Encryption gate routes (shown after login, before home) ───────────────

  // First-time passphrase creation — shown when isKeyBlobPresent is false.
  static const setupPassphrase = '/setup-passphrase';

  // Passphrase recovery — shown when key blob exists but no local key.
  static const recoverPassphrase = '/recover-passphrase';
